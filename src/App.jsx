...
import { Button, Checkbox, ConfigProvider, Form, Input, Select, Segmented, Upload } from 'antd';
...
function App() {
  ...
  <Form
    ...
    autoComplete="off"
  >
     <h1 className='text-center text-3xl text-primary mb-10 '>&lt; Logo Here &frasl; &gt;  </h1> 

  <div className='mb-3'>
  <Segmented value={role} onChange={(value)=>setRole(value)} options={['Shipper','Cargo Company','Driver']} block />
    ...
    <Form.Item
      ...
      extra={<span className='text-secondary text-sm'>Please input all necessary documents</span>}
      accept="image/png, image/gif, image/jpeg, image/svg+xml"
    >
      <Upload multiple maxCount={6} name="logo" action="/upload.do" listType="picture">
